...
get_meme_url(meme_choice):
    if meme_choice == 'old-class':
        pic_url = 'https://upload.wikimedia.org/wikipedia/commons/4/47/StateLibQld_1_100348.jpg'
    elif meme_choice == 'college-grad':
        pic_url = 'https://upload.wikimedia.org/wikipedia/commons/c/ca/LinusPaulingGraduation1922.jpg'
    elif meme_choice == 'thinking-ape':
        pic_url = 'https://upload.wikimedia.org/wikipedia/commons/f/ff/Deep_in_thought.jpg'
    elif meme_choice == 'coding':
        pic_url = 'https://upload.wikimedia.org/wikipedia/commons/b/b9/Typing_computer_screen_reflection.jpg'
...
class EnterInfoHandler(webapp2.RequestHandler):
    ...
    def post(self):
        self.response.write("POST request was made")
